  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(/assets/images/rice-field-hero.jpg)',
        }}
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-6 text-green-100 drop-shadow-md">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/diagnosis"
                className="px-8 py-4 bg-orange-600 hover:bg-orange-700 text-white font-semibold rounded-lg transition inline-flex items-center justify-center shadow-xl hover:shadow-2xl transform hover:scale-105"
              >
              ...
              <Link
                to="/about"
                className="px-8 py-4 bg-white/95 hover:bg-white text-green-700 font-semibold rounded-lg transition inline-flex items-center justify-center shadow-xl hover:shadow-2xl transform hover:scale-105"
              >

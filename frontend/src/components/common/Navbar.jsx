      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center justify-center space-x-1 flex-1">
            <Link to="/" className="px-4 py-2 text-gray-700 hover:text-green-700 hover:bg-green-50 rounded-md transition font-medium">
              Home
            </Link>
            <Link to="/about" className="px-4 py-2 text-gray-700 hover:text-green-700 hover:bg-green-50 rounded-md transition font-medium">
              Tentang
            </Link>
            <Link to="/diagnosis" className="px-4 py-2 text-gray-700 hover:text-green-700 hover:bg-green-50 rounded-md transition font-medium">
              Diagnosa
            </Link>
            <Link to="/history" className="px-4 py-2 text-gray-700 hover:text-green-700 hover:bg-green-50 rounded-md transition font-medium">
              Riwayat
            </Link>
            <Link to="/contact" className="px-4 py-2 text-gray-700 hover:text-green-700 hover:bg-green-50 rounded-md transition font-medium">
              Kontak
            </Link>
          </div>
          ...
          <div className="hidden md:flex items-center flex-shrink-0">
            {isAuthenticated ? (
              ...
              <Link to="/login" className="px-6 py-2 bg-green-700 text-white rounded-md hover:bg-green-800 transition font-medium">
                Login
              </Link>
            )}
          </div>
